...
//! object file for the host machine, ready to be linked with the
//! `native-runtime-static` library into an executable.
//!
...
/// Compiles the given modules to an object file for the host machine, with
/// `main` in `main_module` reachable through the exported entry wrapper.
